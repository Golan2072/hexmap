...
def starmap_print():
    ...
    for row in range(1, 11):
        ...
        print(
            f"  \_____/{starmap[2][row].naval}  {starmap[2][row].worldtype}   \_____/{starmap[4][row].naval}  {starmap[4][row].worldtype}   \_____/{starmap[6][row].naval}  {starmap[6][row].worldtype}   \_____/{starmap[8][row].naval}  {starmap[8][row].worldtype}   \ ")
    print(
